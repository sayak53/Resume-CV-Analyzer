...
function App() {
  ...
  return (
    <>
      <div className="min-h-screen bg-[#020617] flex flex-col items-center py-6 px-4">
        ...
        <footer className="text-center bg-[#020617] text-gray-400 text-sm py-8 border-t border-slate-800 mt-6">
          ...
          <p className="mt-2 text-gray-500">© 2026 Sayak Chakraborty</p>
        </footer>
      </div>
    </>
  );
